window.addEventListener("load", function(){
  ...
  let errorCategoria = document.querySelector(".dinamic-category-feedback");
  ...
  categoriaProducto.addEventListener('blur', (e)=>{
    (categoriaProducto.value + e.key).length < 0 ? errorCategoria.innerHTML = "Debes elegir una categoría" : errorCategoria.innerHTML ="";
  });
